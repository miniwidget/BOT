...
namespace Infected
{
    class Tank
    {
        ...
        internal void SetTank(Entity player)
        {
            ...
            rmt1.Call(32841, remoteTank, "tag_turret_attach", new Vector3(-50, 0, 45f), Infected.ZERO);
            ...
            rmt2.Call(32841, remoteTank, "tag_turret_attach", new Vector3(50, 0, 45f), Infected.ZERO);
        ...
        internal bool CheckTank(Entity player)
        {
            int ti = IsTankOwner(player);
            if (ti != 5)
            {
                TankEnd(player, ti);
                return true;
