...
namespace Infected
{
    public partial class Infected
    {
        ...
        void AxisWeapon_by_init(ref Entity dead)
        {
            ...
            dead.Call(33468, DEAD_GUN, 3);//clip
            dead.Call(33469, DEAD_GUN, 0);//stock
            dead.Notify("open_");
        ...
        void AxisWeapon_by_Attack(ref Entity dead, int aw)
        {
            ...
            else
            {
                ...
                dead.Call(33344, "^2[ AGAIN ] ^7Init Weapon of the Infected");
                return;
            }

            dead.GiveWeapon(deadManWeapon);
            dead.Call(33468, deadManWeapon, bullet);//clip
            dead.Call(33469, deadManWeapon, 0);//stock
            dead.Call(33344, "^2[ " + deadManWeapon + " ] ^7Weapon of the Infected");
            dead.Notify("open_");
